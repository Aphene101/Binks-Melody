import{a as i,g as c,b as d,h as m}from"./main-J_IOh1xE.js";const a=document.getElementById("playlistsContainer"),n=document.getElementById("newPlaylistBtn");async function y(){const t=i.currentUser;if(!t)return;const l=c(d,"users",t.uid,"playlists");(await m(l)).forEach(s=>{const o=s.data(),e=document.createElement("div");e.className="playlist",e.innerHTML=`
      <div></div>
      <p>${o.name}</p>
