import{a as i,h as d,e as m,i as u}from"./main-DDpg8L_D.js";const a=document.getElementById("playlistsContainer"),n=document.getElementById("newPlaylistBtn");async function y(){const t=i.currentUser;if(!t)return;const o=d(m,"users",t.uid,"playlists");(await u(o)).forEach(s=>{const r=s.data(),e=document.createElement("div");e.className="playlist",e.innerHTML=`
      <div></div>
      <p>${r.name}</p>
