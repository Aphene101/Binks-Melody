import{b as i,i as d,a as m,j as u}from"./firebase-DhwcWpw7.js";import"./main-BfolFI2a.js";const a=document.getElementById("playlistsContainer"),n=document.getElementById("newPlaylistBtn");async function y(){const t=i.currentUser;if(!t)return;const o=d(m,"users",t.uid,"playlists");(await u(o)).forEach(s=>{const r=s.data(),e=document.createElement("div");e.className="playlist",e.innerHTML=`
      <div></div>
      <p>${r.name}</p>
